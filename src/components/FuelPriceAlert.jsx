...
const FuelPriceAlert = () => {
  ...
  return (
    <>
        <div onClick={() => setOpen(!open)} className="bg-white border-2 relative border-gray-300 p-3   shadow-sm rounded-3xl m-5 mt-0 mb-5 text-teal-600 sm:flex-row">
            <MdCircleNotifications className="absolute left-5 top-2 text-orange-400 size-10 mr-2 mt-1" />
            <div>
                <h1 className="sm:mr-30 text-gray-600 font-semibold">Fuel Price Alert</h1>
                <p className="sm:mr-18  text-gray-400 text-xs">Get notified when prices drop</p>
