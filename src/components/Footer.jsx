...
const Footer = () => {
  return (
    <footer className="bg-white border overflow-x-hidden border-t-2  fixed bottom-0 left-0 w-227.5 justify-around items-center h-20">
      <div className="grid grid-col md:flex-row">
          <div>
