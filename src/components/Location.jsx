...
const Location = () => {
  ...
  return (
    <>
      <div className="bg-white border-2 border-gray-300 p-2  shadow-sm rounded-3xl m-3 mb-1 text-teal-600">
      ...
      {activeTab === "route" && (
        <>
         <div className="border mb-3 rounded-3xl p-6 items-start gap-5 w-full max-w-4xl relative">
            <CiLocationOn className="text-4xl flex absolute mt-4" />
            <div className="flex flex-col items-start ml-35">
        ...
        <div>
            <button className="border-dashed border-2 p-3  pl-30 flex text-sm w-90  m-4 ml-10">
          ...
          <div>
            <div className="rounded-3xl bg-gray-100 p-5 border border-gray-300 shadow-amber-100">
              ...
              <div className="flex items-center justify-between">
                <input type="number" className="text-black outline-none bg-transparent text-2xl font-semibold" placeholder="Enter distance in km"/>
                <span className="text text-gray-500 ml-4">km</span>
              </div>
            </div>
